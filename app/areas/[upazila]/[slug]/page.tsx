...
export async function generateMetadata({params}:Props){const p=await params;const a=(await getAreas()).find(a=>a.upazila===p.upazila&&a.slug===p.slug);return {title:a?.name??'এলাকা পাওয়া যায়নি'};}
