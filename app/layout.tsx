...
export const metadata:Metadata={
  ...
  openGraph:{type:'website',locale:'bn_BD',url:siteUrl,siteName:'আমার কুমিল্লা এক',title:'আমার কুমিল্লা এক',description:'বাংলাদেশ জামায়াতে ইসলামী কুমিল্লা-১ এলাকার দাউদকান্দি ও মেঘনার প্রকাশিত সংবাদ, নেতৃত্ব, কর্মসূচি ও স্থানীয় তথ্য।',images:[{url:'/logo.svg',width:512,height:512,alt:'আমার কুমিল্লা এক'}]},
};
...
export default function Layout({children}:{children:React.ReactNode}){
  return <html lang="bn"><body>
    <Link className="announcement" href="/news"><strong>সর্বশেষ</strong><span>কুমিল্লা–১ · দাউদকান্দি ও মেঘনার নতুন সংবাদ ও কার্যক্রম</span><b>পড়ুন →</b></Link>

    <header className="site-header">
      <div className="header-inner">
        <Link className="brand" href="/" aria-label="আমার কুমিল্লা এক — হোম">
          <img src="/logo.svg" alt="" width="52" height="52"/>
          <span><strong>আমার কুমিল্লা এক</strong><small>বাংলাদেশ জামায়াতে ইসলামী · কুমিল্লা–১</small></span>
        </Link>

        <nav className="desktop-nav" aria-label="প্রধান মেনু"><NavLinks/></nav>

        <div className="header-actions">
          <Link className="header-link" href="/sections/gallery">গ্যালারি</Link>
          <Link className="header-cta" href="/contact">যোগাযোগ</Link>
          <details className="mobile-nav">
            <summary>মেনু <span aria-hidden="true">☰</span></summary>
            <nav><NavLinks/><Link href="/sections/gallery">গ্যালারি</Link><Link href="/contact">যোগাযোগ</Link></nav>
          </details>
        </div>
      </div>
    </header>
    ...
    <footer className="site-footer">
      <div className="footer-top">
        <div className="footer-brand">
          ...
          <div><strong>আমার কুমিল্লা এক</strong><p>দাউদকান্দি ও মেঘনার দলীয় সংবাদ, নেতৃত্ব, কার্যক্রম ও স্থানীয় তথ্য।</p></div>
        </div>
