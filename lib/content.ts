...
export type Post={id:string;title:string;slug:string;body:string;kind:string;status:string;author_id:string;published_at:string|null;created_at:string;updated_at:string;area_keys:string[];media_paths:string[];event_at:string|null;venue:string};
